...
//ColumnIds.Add(`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSTOTAL)
//ColumnIds.Add(`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSSCORED)
//ColumnIds.Add(`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSMAX)	

//ColumnIds.Add(`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_POOLPOINTS)	
//ColumnIds.Add(`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_RETRIBUTIONS)
...
//ColumnMappings.Add((Id=`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSTOTAL,Name="EVENT_SKULLSTOTAL"))
//ColumnMappings.Add((Id=`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSSCORED,Name="EVENT_SKULLSSCORED"))
//ColumnMappings.Add((Id=`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_SKULLSMAX,Name="EVENT_SKULLSMAX"))	

//ColumnMappings.Add((Id=`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_POOLPOINTS,Name="EVENT_POOLPOINTS"))	
//ColumnMappings.Add((Id=`STATS_COLUMN_DM_RANKED_ALLTIME_EVENT_RETRIBUTIONS,Name="EVENT_RETRIBUTIONS"))
