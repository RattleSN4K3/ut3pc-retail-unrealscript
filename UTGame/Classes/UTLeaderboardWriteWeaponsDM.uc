...
Properties.Add((PropertyId=`PROPERTY_DEATHS_AVRIL,Data=(Type=SDT_Int32,Value1=0)))
...
Properties.Add((PropertyId=`PROPERTY_KILLS_AVRIL,Data=(Type=SDT_Int32,Value1=0)))
...
Properties.Add((PropertyId=`PROPERTY_SUICIDES_AVRIL,Data=(Type=SDT_Int32,Value1=0)))
...
StatNameToStatIdMapping.Add((StatName=DEATHS_AVRIL,Id=`PROPERTY_DEATHS_AVRIL))
...
StatNameToStatIdMapping.Add((StatName=KILLS_AVRIL,Id=`PROPERTY_KILLS_AVRIL))
...
StatNameToStatIdMapping.Add((StatName=SUICIDES_AVRIL,Id=`PROPERTY_SUICIDES_AVRIL))
