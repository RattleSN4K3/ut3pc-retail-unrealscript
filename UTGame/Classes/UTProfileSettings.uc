...
defaultproperties
{
	...
	ProfileSettingIds.Add(UTPID_BioRiflePriority)
	ProfileSettingIds.Add(UTPID_FlakCannonPriority)
	ProfileSettingIds.Add(UTPID_SniperRiflePriority)
	ProfileSettingIds.Add(UTPID_LinkGunPriority)
	ProfileSettingIds.Add(UTPID_EnforcerPriority)
	ProfileSettingIds.Add(UTPID_ShockRiflePriority)
	ProfileSettingIds.Add(UTPID_StingerPriority)
	ProfileSettingIds.Add(UTPID_AVRILPriority)
	ProfileSettingIds.Add(UTPID_RedeemerPriority)
	...
	// Warfare/Onslaught
	ProfileSettingIds.Add(UTPID_PopupMapOnDeath)
    ...
    ProfileSettingIDs.Add(PSI_ModifierCardDeck0);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck1);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck2);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck3);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck4);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck5);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck6);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck7);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck8);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck9);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck10);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck11);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck12);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck13);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck14);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck15);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck16);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck17);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck18);
    ProfileSettingIDs.Add(PSI_ModifierCardDeck19);
	...
	ProfileMappings[69]=(Id=UTPID_BioRiflePriority,Name="UTGame.UTWeap_BioRifle_Priority",MappingType=PVMT_RawValue)
	ProfileMappings[70]=(Id=UTPID_FlakCannonPriority,Name="UTGame.UTWeap_FlakCannon_Priority",MappingType=PVMT_RawValue)
	ProfileMappings[71]=(Id=UTPID_SniperRiflePriority,Name="UTGame.UTWeap_SniperRifle_Priority",MappingType=PVMT_RawValue)
	...
	ProfileMappings.Add((Id=PSI_ModifierCardDeck0, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck1, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck2, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck3, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck4, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck5, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck6, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck7, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck8, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck9, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck10, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck11, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck12, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck13, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck14, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck15, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck16, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck17, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck18, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	ProfileMappings.Add((Id=PSI_ModifierCardDeck19, Name="ModifierCardDeck0",MappingType=PVMT_RawValue))
	...
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_BioRiflePriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_FlakCannonPriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_SniperRiflePriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_LinkGunPriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_EnforcerPriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_ShockRiflePriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_StingerPriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_AVRILPriority,Data=(Type=SDT_Float))))
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_RedeemerPriority,Data=(Type=SDT_Float))))
	...
	// Onslaught/Warfare
	DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=UTPID_PopupMapOnDeath,Data=(Type=SDT_Int32,Value1=UTPID_VALUE_YES))))
    ...
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck0,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck1,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck2,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck3,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck4,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck5,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck6,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck7,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck8,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck9,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck10,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck11,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck12,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck13,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck14,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck15,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck16,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck17,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck18,Data=(Type=SDT_Int32,Value1=-1)))
    DefaultSettings.Add((Owner=OPPO_Game,ProfileSetting=(PropertyId=PSI_ModifierCardDeck19,Data=(Type=SDT_Int32,Value1=-1)))
	...
	DigitalButtonActionsToCommandMapping[DBA_Taunt]="GBA_Taunt1";
	DigitalButtonActionsToCommandMapping[DBA_Taunt2]="GBA_Taunt2";
	...
	CampaignBoneNames.Add(B_CTFCoret)
	CampaignBoneNames.Add(B_DMHeatray)
	CampaignBoneNames.Add(B_CTFDeny)
	CampaignBoneNames.Add(B_DMGateway)
	CampaignBoneNames.Add(B_DMArsenal)
	CampaignBoneNames.Add(B_ONSPowerSurge)
	CampaignBoneNames.Add(B_ONSDusk)
	CampaignBoneNames.Add(B_ONSIslander)
	CampaignBoneNames.Add(B_DMRisingsun)
	CampaignBoneNames.Add(B_DMShangrila)
	CampaignBoneNames.Add(B_CTFCorruption)
	CampaignBoneNames.Add(B_ONSMarketdistrict)
	CampaignBoneNames.Add(B_ONSDownUnder)
	CampaignBoneNames.Add(B_ONSDmz)
	CampaignBoneNames.Add(B_CTFReflection)
	CampaignBoneNames.Add(B_ONSTorlan)
	CampaignBoneNames.Add(B_ONSSerenity)
	CampaignBoneNames.Add(B_ONSJumpgate)
	CampaignBoneNames.Add(B_ONSOnyxcoast)
	CampaignBoneNames.Add(B_DMHardcore)
	CampaignBoneNames.Add(B_ONSColdHarbor)
	CampaignBoneNames.Add(B_CTFKargo)
	CampaignBoneNames.Add(B_CTFHydrosis)
	CampaignBoneNames.Add(B_CTFSuspense)
	CampaignBoneNames.Add(B_DMDeck)
	CampaignBoneNames.Add(B_DMDiesel)
	CampaignBoneNames.Add(B_ONSDowntown)
	CampaignBoneNames.Add(B_DMDefiance)
	CampaignBoneNames.Add(B_CTFSandstorm)
	CampaignBoneNames.Add(B_DMSentinel)
	CampaignBoneNames.Add(B_ONSSublevels)
	CampaignBoneNames.Add(B_CTFNecropolis)
	CampaignBoneNames.Add(B_CTFVertibrae)
