...
simulated function SetHoverBoardAttachPointInUse(name PointName, bool bInUse)
{
	...
	if ( !bFound )
	{
		`log("WARNING: "@PointName@" not found on"@self);
	}
}
...
defaultproperties
{
	...
	HornSounds[1]=SoundCue'A_Vehicle_Generic.Vehicle.VehicleHornCue' // Big axon
	HornSounds[2]=SoundCue'A_Vehicle_Generic.Vehicle.Vehicle_Horn_SmallNecris01Cue' // Small necris
	HornSounds[3]=SoundCue'A_Vehicle_Generic.Vehicle.Vehicle_Horn_LargeNecris03Cue' // Big necris
