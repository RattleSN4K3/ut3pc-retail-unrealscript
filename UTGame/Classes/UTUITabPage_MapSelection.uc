...
function OnShowMapCycle()
{
	...
	if(MapCyclePanel.IsVisible())
	{
		MapCyclePanel.OnUIAnimEnd=OnMapPanel_Hide_UIAnimEnd;
		MapCyclePanel.PlayUIAnimation('TabPageExitLeft');
	}
	else
	{
		SingleMapPanel.OnUIAnimEnd=OnMapPanel_Hide_UIAnimEnd;
...
function OnMapPanel_Hide_UIAnimEnd(UIObject AnimTarget, int AnimIndex, UIAnimationSeq AnimSeq)
{
	...
	if(MapCyclePanel.IsVisible())
	{
		SingleMapPanel.OnUIAnimEnd=OnMapPanel_Show_UIAnimEnd;
	...
	{
		MapCyclePanel.OnUIAnimEnd=OnMapPanel_Show_UIAnimEnd;
