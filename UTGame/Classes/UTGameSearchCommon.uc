...
defaultproperties
{
	...
	LocalizedSettings(1)=(Id=CONTEXT_PURESERVER,ValueIndex=CONTEXT_PURESERVER_YES,AdvertisementType=ODAT_OnlineService)
	...
	LocalizedSettings(2)=(Id=CONTEXT_LOCKEDSERVER,ValueIndex=CONTEXT_LOCKEDSERVER_NO,AdvertisementType=ODAT_OnlineService)
	...
	LocalizedSettings(5)=(Id=CONTEXT_FULLSERVER,ValueIndex=CONTEXT_FULLSERVER_NO,AdvertisementType=ODAT_OnlineService)
