...
defaultproperties
{
	...
	Seats(0)={(	GunClass=class'UTVWeap_StealthBenderGold_Content',
	...
	DeployablePositionOffsets(0)=(X=10,Y=0,Z=-15)  //Spider Mine
	DeployablePositionOffsets(1)=(X=10,Y=0,Z=-15)  //Slow Volume
