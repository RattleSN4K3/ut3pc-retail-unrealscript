class UTLinkGeneratorRed extends UTLinkGenerator;

simulated function AddBeamEmitters()
{
	Super.AddBeamEmitters();
	DischargeEffect.SetVectorParameter('LinkColor', vect(1.0, 0.2, 0.2));
}

defaultproperties
{
	TeamNum=0
	LinkBeamSystem=ParticleSystem'FX_Gametypes.Effects.P_Link_Generator_Beam_Red'
	LinkBeamColor=(R=255,G=64,B=64,A=255)
	BeamEndpointTemplate=ParticleSystem'WP_LinkGun.Effects.P_WP_Linkgun_Beam_Impact_Red'
	BeamTemplate=ParticleSystem'FX_Gametypes.Effects.P_Link_Generator_Beam_Red'
