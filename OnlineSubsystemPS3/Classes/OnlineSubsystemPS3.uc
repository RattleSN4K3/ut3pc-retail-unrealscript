 ...
 */
class OnlineSubsystemPS3 extends OnlineSubsystemCommonImpl
	native
	implements(OnlinePlayerInterface)
	config(Engine);
 ...
 */
var native const array<pointer> AsyncTasks{FOnlineAsyncTaskPS3};
...
var bool bNeedsKeyboardTicking;
