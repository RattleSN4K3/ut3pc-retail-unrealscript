...
defaultproperties
{
	...
	VehicleEffects(0)=(EffectStartTag=CicadaWeapon01,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Muzzleflash',EffectSocket=Gun_Socket_01)
	VehicleEffects(1)=(EffectStartTag=CicadaWeapon02,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Muzzleflash',EffectSocket=Gun_Socket_02)
	VehicleEffects(2)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=LeftWingtip,bHighDetailOnly=true)
	VehicleEffects(3)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=RightWingtip,bHighDetailOnly=true)
	VehicleEffects(4)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=LeftFrtTrail,bHighDetailOnly=true)
	VehicleEffects(5)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=RightFrtTrail,bHighDetailOnly=true)

	VehicleEffects(8)=(EffectStartTag=TurretWeapon00,EffectEndTag=STOP_TurretWeapon00,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_2ndAltFlash',EffectSocket=Turret_Gun_Socket_01)
	VehicleEffects(6)=(EffectStartTag=TurretWeapon01,EffectEndTag=STOP_TurretWeapon01,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_2ndAltFlash',EffectSocket=Turret_Gun_Socket_02)
	VehicleEffects(7)=(EffectStartTag=TurretWeapon02,EffectEndTag=STOP_TurretWeapon02,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_2ndAltFlash',EffectSocket=Turret_Gun_Socket_03)
	VehicleEffects(9)=(EffectStartTag=TurretWeapon03,EffectEndTag=STOP_TurretWeapon03,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_2ndAltFlash',EffectSocket=Turret_Gun_Socket_04)
	...
	VehicleEffects(13)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=LeftWingtipb,bHighDetailOnly=true)
	VehicleEffects(14)=(EffectStartTag=EngineStart,EffectEndTag=EngineStop,EffectTemplate=ParticleSystem'VH_Cicada.Effects.P_VH_Cicada_Contrail',EffectSocket=RightWingtipb,bHighDetailOnly=true)
	VehicleEffects(15)=(EffectStartTag=DamageSmoke,EffectEndTag=NoDamageSmoke,bRestartRunning=false,EffectTemplate=ParticleSystem'Envy_Effects.Vehicle_Damage.P_Vehicle_Damage_1_Cicada',EffectSocket=DamageSmoke_01)
