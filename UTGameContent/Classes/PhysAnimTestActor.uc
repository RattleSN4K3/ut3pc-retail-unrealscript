...
function Tick(float DeltaSeconds)
{
	...
	if(bRampingDownMotors)
	{
		...
		else if(MotorDownStartTime + MotorDownTime > WorldInfo.TimeSeconds)
		{
			...
			SkeletalMeshComponent.PhysicsAssetInstance.SetAllMotorsAngularDriveStrength(MotorScale * StaggerMuscleScale, MotorScale * StaggerMuscleScale, 1.f, SkeletalMeshComponent);
		...
		else
		{
			...
			SkeletalMeshComponent.PhysicsAssetInstance.SetAllMotorsAngularDriveStrength(1.f, 1.f, 1.f, SkeletalMeshComponent);
		}
	}
...
defaultproperties
{
	...
	Begin Object Class=SkeletalMeshComponent Name=SkeletalMeshComponent0
		...
		RBCollideWithChannels=(Default=true,EffectPhysics=true,GameplayPhysics=true)
	End Object
