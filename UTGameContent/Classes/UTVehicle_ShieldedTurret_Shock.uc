...
defaultproperties
{
	Seats(0)={(	GunClass=class'UTVWeap_TurretShock',
	...
	VehicleEffects(1)=(EffectStartTag=TurretFireLeft,EffectTemplate=ParticleSystem'VH_Leviathan.Effects.P_VH_Leviathan_TurretShockMF',EffectSocket=GunLeft)
	VehicleEffects(2)=(EffectStartTag=TurretFireRight,EffectTemplate=ParticleSystem'VH_Leviathan.Effects.P_VH_Leviathan_TurretShockMF',EffectSocket=GunRight)
}
