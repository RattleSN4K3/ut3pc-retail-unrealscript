...
DefaultProperties
{
	...
	PrivateFlags=0x280
	NotifyActiveStateChanged=OnActiveStateChanged

	ButtonClass=class'Engine.UITabButton'

	ButtonCaption=(RequiredFieldType=DATATYPE_Property,BindingIndex=CAPTION_DATABINDING_INDEX)
	ButtonToolTip=(RequiredFieldType=DATATYPE_Property,BindingIndex=TOOLTIP_DATABINDING_INDEX)
	PageDescription=(RequiredFieldType=DATATYPE_Property,BindingIndex=DESCRIPTION_DATABINDING_INDEX)
}
